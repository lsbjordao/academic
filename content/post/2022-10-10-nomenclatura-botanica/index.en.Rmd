...
```{r atos, echo=FALSE, warning=FALSE, fig.cap="Gráfico de conjunto sobre os conceitos importantes sobre nomenclatura: atos nomenclaturais, novidade nomenclatural, mudança nomenclatural, tipificação."}
