...
### Novidade nomenclatural vs. Mudança nomenclatural
...
Veja a figura \@ref(fig:atosFig), que sintetiza os conceitos acima.

```{r atos, fig.cap="Gráfico de conjunto sobre os conceitos importantes sobre nomenclatura: atos nomenclaturais", include=FALSE}
...
```{r atosFig, echo=FALSE, fig.align='center', fig.cap='Atos nomenclaturais', fig.pos='H', message=FALSE, warning=FALSE}
