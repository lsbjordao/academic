...
date: '2019-05-08'
customjs:
 - http://code.jquery.com/jquery-v1.12.4.min.js
...
- Visite:
  ...
  - A página [Leaflet-providers](http://leaflet-extras.github.io/leaflet-providers/preview/) com previews de basemap que podem ser utilizados no pacote `Leaflet`;   - A página do [GBIF Maps API](https://www.gbif.org/developer/maps) para entender entender a ferramenta Web API do GBIF.
