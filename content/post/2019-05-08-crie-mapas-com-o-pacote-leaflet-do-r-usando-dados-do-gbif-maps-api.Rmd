...
- Visite:
  ...
  - a página de documentos oficial do R, onde constam todas as funções;
  - [GBIF Maps API](https://www.gbif.org/developer/maps);
  - Escolha um mapa base ('basemap') no [Leaflet-providers](http://leaflet-extras.github.io/leaflet-providers/preview/)
