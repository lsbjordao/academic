...
- Visite:
  ...
  - A página do [GBIF Maps API](https://www.gbif.org/developer/maps) para entender entender a ferramenta Web API do GBIF;
  - A página [Leaflet-providers](http://leaflet-extras.github.io/leaflet-providers/preview/) com previews de basemap.
