...
```{r atos, echo=FALSE, fig.cap="Gráfico de conjunto sobre os conceitos importantes sobre nomenclatura: atos nomenclaturais, warning=FALSE, novidade nomenclatural, mudança nomenclatural, tipificação."}
library(DiagrammeR)
grViz("digraph{
