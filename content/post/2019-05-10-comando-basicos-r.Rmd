...
sin(10)                     # seno
tan(10)                     # tangente
acos(0.1)                   # arco cosseno
asin(1)                     # arco seno
atan(1)                     # arco tangente
acosh(10)                   # arco cosseno hiperbólico
asinh(0.1)                  # arco seno hiperbólico
atanh(0.1)                  # arco tangente hiperbólico
```
...
## Constantes do <i class="fab fa-r-project" style="color:blue"></i>
```{r}
LETTERS
letters
month.abb
...
## **O <i class="fab fa-r-project" style="color:blue"></i> é uma linguagem de POO (Programação Orientada a Objetos)**
