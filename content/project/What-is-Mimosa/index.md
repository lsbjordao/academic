...
- *Mimosa* is a megadiverse Neotropical genus, with about 700 species, and ca. 40 species in Old World, but several species became pantropical. ^See^ ^the^ ^[post]()^ ^showing^ ^the^ ^Leaflet^ ^R^ ^package^ ^([Cheng et al. 2018](https://cran.r-project.org/web/packages/leaflet/leaflet.pdf)).^
